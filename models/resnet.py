...
class ResNet34(nn.Module):
    '''
    Residual network with 34 layers (ResNet34)
    ...
    Arg(s):
        ...
        batch_norm : bool
            whether or not to use batch normalization
    '''
#   (conv3-64 + conv3-64 + skip connection) x 3
# - (conv3-128 + conv3-128 + skip connection) x 4
# - (conv3-256 + conv3-256 + skip connection) x 6
# - (conv3-512 + conv3-512 + skip connection) x 3
    def __init__(self, n_input_feature, n_output, batch_norm=False):
